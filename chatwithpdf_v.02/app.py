...
from final_llm_chain import  load_pdf_chat_chain
from langchain.memory import StreamlitChatMessageHistory
from streamlit_mic_recorder import mic_recorder
from final_llm_chain import save_chat_history_json ,get_timestamp,load_chat_history_json
from final_llm_chain  import add_documents_to_db
...
def main():
    ...
    upload_pdf = st.sidebar.file_uploader("Upload a pdf file", accept_multiple_files=True, key= "pdf_upload",type=["pdf"])
